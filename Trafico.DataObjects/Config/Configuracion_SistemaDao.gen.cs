...
namespace Trafico.DataObjects.Config
{
    ...
    public partial class Configuracion_SistemaDao : DataAccessBase
    {
        ...
        {
            using (DbCommand dbCmd = Db.GetStoredProcCommand("Config.spu_Configuracion_Sistema_Guardar")){
        ...
        {
            return Db.ExecuteNonQuery("Config.spu_Configuracion_Sistema_Eliminar",Variable);
        }
        
        public virtual CConfiguracion_Sistema Recuperar(String Variable)
        {
            DataTable dtDatos = Db.ExecuteDataSet("Config.spu_Configuracion_Sistema_Recuperar",Variable).Tables[0];
        ...
        {
            using (IDataReader dr = Db.ExecuteReader(CommandType.StoredProcedure,"Config.spu_Configuracion_Sistema_Listar")){
