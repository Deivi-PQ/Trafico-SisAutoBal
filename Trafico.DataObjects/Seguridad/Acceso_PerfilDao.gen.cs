...
namespace Trafico.DataObjects.Seguridad
{
    ...
    public partial class Acceso_PerfilDao : DataAccessBase
    {
        ...
        {
            using (DbCommand dbCmd = Db.GetStoredProcCommand("Seguridad.spu_Acceso_Perfil_Guardar")){
            Db.AddInParameter(dbCmd, "Cod_Acceso", DbType.String, oAcceso_Perfil.Cod_Acceso);
            Db.AddInParameter(dbCmd, "IDPerfil", DbType.Int32, oAcceso_Perfil.IDPerfil);
        ...
        {
            return Db.ExecuteNonQuery("Seguridad.spu_Acceso_Perfil_Eliminar",Cod_Acceso,IDPerfil);
        }
        
        public virtual CAcceso_Perfil Recuperar(String Cod_Acceso, Int32 IDPerfil)
        {
            DataTable dtDatos = Db.ExecuteDataSet("Seguridad.spu_Acceso_Perfil_Recuperar",Cod_Acceso,IDPerfil).Tables[0];
        ...
        {
            using (IDataReader dr = Db.ExecuteReader(CommandType.StoredProcedure,"Seguridad.spu_Acceso_Perfil_Listar")){
